...
# Performing mathematical operations with ints. Note the return types!
print(2+3)
print(2*3)
print(2/3)
...
# If you type the line above yourself and you're working in the standard Python
#  console in Spyder, pause after typing "myString." and it should give you a
#  list of all available methods. This won't happen in the IPython console or
#  in Jupyter. However, try dir() to see a full list of methods available for
#  any object.
dir(myString)
...
# Note that you can avoid newlines and spaces by importing the sys library and 
# using sys.stdout.write() in place of print(). Normally, all libraries are
...
gives it the shorthand name 'scp'. When we import a package this way, we have 
to preface all functions from that package with 'scp'.
"""
import scipy as scp
